...
struct Translation: Codable{
    ...
    static func endpointForID( id: Int) -> String {
        return "http://gfish.ad.ilstu.edu:8080/ForeignWordsRESTApp/webresources/entities.foreignwords/\(id)"
    }
    ...
    static func translateByID ( id: Int, completionHandler: @escaping (Translation?, Error?) -> Void)  {
        let endpoint = Translation.endpointForID(id: id)
